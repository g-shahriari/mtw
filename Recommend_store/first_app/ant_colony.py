...
class AntColony():
    ...
    def selected_points_weights_and_max_distance(self,points,points_pheromone):
        ...
        points_code_1=points[0][1]
        points_pheromone_1=points_pheromone[0]
        points_position_1=[[points[0][2],points[0][3]]]
        points_weights_1=points[0][4]
        ...
        points_code_candidate.append(points_code_1)
        ...
        for k in range(0,4):
            if points_code_selected[k]==points_code_1:
                point_code_position_x.append(points_position_1[0][0])
                point_code_position_y.append(points_position_1[0][1])
                point_position.append([points_position_1[0][0],points_position_1[0][1]])
                point_code_weight.append([points_code_1,points_weights_1,points_pheromone_1])
        ...
        for i in range(0,1000):
            ...
            if fit_func_candidate<fit_func and fit_func_candidate != -9999:
                ...
                for i in range(0,len(selected_weights)):
                    for k,n,m in zip(range(0,len(points_code_2)),range(0,len(points_code_3)),range(0,len(points_code_4))):
                        if points_code_1==point_code_weight_max_dist[i][0]:
                            points_pheromone_1=self.update_pheromone(point_pheromone=point_code_weight_max_dist[i][2],point_code=point_code_weight_max_dist[i][0])
                ...
                for k,n,m in zip(range(0,len(points_code_2)),range(0,len(points_code_3)),range(0,len(points_code_4))):
                    points_pheromone_1=self.evaporation_pheromone(points_pheromone=points_pheromone_1,ro_value=0.1)
                    points_pheromone_2[k]=self.evaporation_pheromone(points_pheromone=points_pheromone_2[k],ro_value=0.1)
                    points_pheromone_3[m]=self.evaporation_pheromone(points_pheromone=points_pheromone_3[m],ro_value=0.1)
                    points_pheromone_4[n]=self.evaporation_pheromone(points_pheromone=points_pheromone_4[n],ro_value=0.1)
